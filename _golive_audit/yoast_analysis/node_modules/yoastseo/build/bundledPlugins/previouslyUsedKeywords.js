  ...
  scoreAssessment(previouslyUsedKeywords, paper) {
    if (Object.keys(previouslyUsedKeywords).length === 0) {
      return {
        ...
        (0, _i18n.__)("%1$sPreviously used keyphrase%3$s: No focus keyphrase was set for this page. " + "%2$sPlease add a focus keyphrase you haven't used before on other content%3$s.", "wordpress-seo"), this.urlTitle, this.urlCallToAction, "</a>"),
        score: 1
      };
    }
