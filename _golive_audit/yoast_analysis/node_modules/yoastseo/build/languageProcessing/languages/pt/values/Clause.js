...
class PortugueseClause extends Clause {
  ...
  checkParticiples() {
    ...
    const foundParticiples = this.getParticiples().filter(participle => !directPrecedenceException(clause, participle, _functionWords.cannotDirectlyPrecedePassiveParticiple));
    this.setPassive(foundParticiples.length > 0);
  }
}
var _default = exports.default = PortugueseClause;
