...
function determineStem(word, morphologyDataGerman) {
   ...
   */
  return findStemOnNounExceptionList(morphologyDataGerman.nouns.exceptionStems, stemmedWord) || findStemOnAdjectiveExceptionList(morphologyDataGerman.adjectives, stemmedWord) || findStemOnVerbExceptionList(verbData, stemmedWord) || (0, _detectAndStemRegularParticiple.detectAndStemRegularParticiple)(verbData, word) || stemmedWord;
}
