...
class HungarianClause extends Clause {
   ...
   */
  checkParticiples() {
    const foundParticiples = this.getParticiples().filter(participle => !_nonPassivesInVaAndVe.default.includes(participle));
    this.setPassive(foundParticiples.length > 0);
  }
}
var _default = exports.default = HungarianClause;
