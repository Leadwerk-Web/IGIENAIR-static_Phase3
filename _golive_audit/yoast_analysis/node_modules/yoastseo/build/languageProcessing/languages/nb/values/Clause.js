...
class NorwegianClause extends Clause {
  ...
  checkParticiples() {
    ...
    const passiveParticiples = this.getParticiples().filter(participle => !precedenceException(clause, participle, _functionWords.cannotBeBetweenPassiveAuxiliaryAndParticiple));
    this.setPassive(passiveParticiples.length > 0);
  }
}
var _default = exports.default = NorwegianClause;
