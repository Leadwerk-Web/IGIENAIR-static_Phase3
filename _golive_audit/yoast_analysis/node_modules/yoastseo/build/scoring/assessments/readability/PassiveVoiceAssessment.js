...
class PassiveVoiceAssessment extends _assessment.default {
  ...
  constructor(config = {}) {
    super();
    const defaultConfig = {
      urlTitle: (0, _helpers.createAnchorOpeningTag)("https://yoa.st/34t"),
      urlCallToAction: (0, _helpers.createAnchorOpeningTag)("https://yoa.st/34u")
    };
  ...
  calculatePassiveVoiceResult(passiveVoice) {
    ...
    if (score >= 7) {
      return {
        ...
        (0, _i18n.__)("%1$sPassive voice%2$s: You are not using too much passive voice. That's great!", "wordpress-seo"), this._config.urlTitle, "</a>")
      };
    }
    return {
      score: score,
