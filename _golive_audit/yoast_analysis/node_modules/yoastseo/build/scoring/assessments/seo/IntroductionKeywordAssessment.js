...
class IntroductionKeywordAssessment extends _assessment.default {
  ...
  constructor(config = {}) {
    ...
    const defaultConfig = {
      ...
      urlTitle: (0, _helpers.createAnchorOpeningTag)("https://yoa.st/33e"),
      urlCallToAction: (0, _helpers.createAnchorOpeningTag)("https://yoa.st/33f")
    };
  ...
  calculateResult() {
    if (!this._canAssess) {
      return {
        ...
        (0, _i18n.__)("%1$sKeyphrase in introduction%3$s: %2$sPlease add both a keyphrase and an introduction containing the keyphrase%3$s.", "wordpress-seo"), this._config.urlTitle, this._config.urlCallToAction, "</a>")
      };
    }
