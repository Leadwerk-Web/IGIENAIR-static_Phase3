...
class TextLengthAssessment extends _assessment.default {
  ...
  constructor(config = {}) {
    ...
    const defaultConfig = {
      ...
      urlTitle: (0, _helpers.createAnchorOpeningTag)("https://yoa.st/34n"),
      urlCallToAction: (0, _helpers.createAnchorOpeningTag)("https://yoa.st/34o"),
  ...
  getLanguageSpecificConfig(researcher) {
    ...
    if (currentConfig.cornerstoneContent === true && currentConfig.customContentType === "" && Object.hasOwn(languageSpecificConfig, "defaultCornerstone")) {
  ...
  getFeedbackTexts() {
    return {
      firstSentence: (useCharacter, textLength) => {
        ...
        (0, _i18n._n)("%2$sText length%3$s: The text contains %1$d word.", "%2$sText length%3$s: The text contains %1$d words.", textLength, "wordpress-seo"), textLength, this._config.urlTitle, "</a>");
        ...
        (0, _i18n._n)("%2$sText length%3$s: The text contains %1$d character.", "%2$sText length%3$s: The text contains %1$d characters.", textLength, "wordpress-seo"), textLength, this._config.urlTitle, "</a>");
        return useCharacter ? characterFeedback : wordFeedback;
      },
      good: textContains => {
        return (0, _i18n.sprintf)(/* translators: %1$s expands to the sentence "The text contains X word(s)." or "The text contains X character(s)." */
        (0, _i18n.__)("%1$s Good job!", "wordpress-seo"), textContains);
      },
      slightlyBelow: (useCharacter, textContains) => {
        const wordFeedback = (0, _i18n.sprintf)(/* translators: %1$d expands to the number of words, %2$s expands to the sentence "The text contains X word(s).", %3$s expands to a link on yoast.com, %4$s expands to the anchor end tag. */
        (0, _i18n._n)("%2$s This is slightly below the recommended minimum of %1$d word. %3$sAdd more content%4$s.", "%2$s This is slightly below the recommended minimum of %1$d words. %3$sAdd more content%4$s.", this._config.recommendedMinimum, "wordpress-seo"), this._config.recommendedMinimum, textContains, this._config.urlCallToAction, "</a>");
        const characterFeedback = (0, _i18n.sprintf)(/* translators: %1$d expands to the number of characters, %2$s expands to the sentence "The text contains X character(s).", %3$s expands to a link on yoast.com, %4$s expands to the anchor end tag. */
        (0, _i18n._n)("%2$s This is slightly below the recommended minimum of %1$d character. %3$sAdd more content%4$s.", "%2$s This is slightly below the recommended minimum of %1$d characters. %3$sAdd more content%4$s.", this._config.recommendedMinimum, "wordpress-seo"), this._config.recommendedMinimum, textContains, this._config.urlCallToAction, "</a>");
        return useCharacter ? characterFeedback : wordFeedback;
      },
      below: (useCharacter, textContains) => {
        const wordFeedback = (0, _i18n.sprintf)(/* translators: %1$d expands to the number of words, %2$s expands to the sentence "The text contains X word(s).", %3$s expands to a link on yoast.com, %4$s expands to the anchor end tag. */
        (0, _i18n._n)("%2$s This is below the recommended minimum of %1$d word. %3$sAdd more content%4$s.", "%2$s This is below the recommended minimum of %1$d words. %3$sAdd more content%4$s.", this._config.recommendedMinimum, "wordpress-seo"), this._config.recommendedMinimum, textContains, this._config.urlCallToAction, "</a>");
        const characterFeedback = (0, _i18n.sprintf)(/* translators: %1$d expands to the number of characters, %2$s expands to the sentence "The text contains X character(s).", %3$s expands to a link on yoast.com, %4$s expands to the anchor end tag. */
        (0, _i18n._n)("%2$s This is below the recommended minimum of %1$d character. %3$sAdd more content%4$s.", "%2$s This is below the recommended minimum of %1$d characters. %3$sAdd more content%4$s.", this._config.recommendedMinimum, "wordpress-seo"), this._config.recommendedMinimum, textContains, this._config.urlCallToAction, "</a>");
        return useCharacter ? characterFeedback : wordFeedback;
      },
      farBelow: (useCharacter, textContains) => {
        const wordFeedback = (0, _i18n.sprintf)(/* translators: %1$d expands to the number of words, %2$s expands to the sentence "The text contains X word(s).", %3$s expands to a link on yoast.com, %4$s expands to the anchor end tag. */
        (0, _i18n._n)("%2$s This is far below the recommended minimum of %1$d word. %3$sAdd more content%4$s.", "%2$s This is far below the recommended minimum of %1$d words. %3$sAdd more content%4$s.", this._config.recommendedMinimum, "wordpress-seo"), this._config.recommendedMinimum, textContains, this._config.urlCallToAction, "</a>");
        const characterFeedback = (0, _i18n.sprintf)(/* translators: %1$d expands to the number of characters, %2$s expands to the sentence "The text contains X character(s).", %3$s expands to a link on yoast.com, %4$s expands to the anchor end tag. */
        (0, _i18n._n)("%2$s This is far below the recommended minimum of %1$d character. %3$sAdd more content%4$s.", "%2$s This is far below the recommended minimum of %1$d characters. %3$sAdd more content%4$s.", this._config.recommendedMinimum, "wordpress-seo"), this._config.recommendedMinimum, textContains, this._config.urlCallToAction, "</a>");
        return useCharacter ? characterFeedback : wordFeedback;
      }
    };
  }
  ...
  calculateTaxonomyResult(textLength) {
    ...
    if ((0, _lodash.inRange)(textLength, this._config.slightlyBelowMinimum, this._config.recommendedMinimum)) {
      return {
    ...
    if ((0, _lodash.inRange)(textLength, this._config.veryFarBelowMinimum, this._config.slightlyBelowMinimum)) {
      return {
  ...
  calculateResult(textLength) {
    ...
    if ((0, _lodash.inRange)(textLength, 0, this._config.belowMinimum)) {
      let badScore = this._config.scores.farBelowMinimum;
      if ((0, _lodash.inRange)(textLength, 0, this._config.veryFarBelowMinimum)) {
