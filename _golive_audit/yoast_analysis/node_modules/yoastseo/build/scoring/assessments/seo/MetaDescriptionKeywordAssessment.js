...
class MetaDescriptionKeywordAssessment extends _assessment.default {
  ...
  constructor(config = {}) {
    ...
    const defaultConfig = {
      ...
      urlTitle: (0, _helpers.createAnchorOpeningTag)("https://yoa.st/33k"),
      urlCallToAction: (0, _helpers.createAnchorOpeningTag)("https://yoa.st/33l")
    };
  ...
  getResult(paper, researcher) {
    ...
    if (assessmentResult.getScore() < 9) {
      ...
      if (paper.hasKeyword()) {
        ...
        assessmentResult.setEditFieldAriaLabel((0, _i18n.__)("Edit your meta description", "wordpress-seo"));
      } else {
  ...
  calculateResult() {
    if (!this._canAssess) {
      return {
        ...
        (0, _i18n.__)("%1$sKeyphrase in meta description%3$s: %2$sPlease add both a keyphrase and a meta description containing the keyphrase%3$s.", "wordpress-seo"), this._config.urlTitle, this._config.urlCallToAction, "</a>")
      };
    }
